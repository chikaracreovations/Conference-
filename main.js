...
/**
 * Function to save registration details to Firestore
 */
 ...
 async function payNow() {
    ...
    try {
        ...
        // ✅ Razorpay Payment Integration
        var options = {
            "key": "rzp_live_FwIm6UiuYORW1Z", // Replace with your Razorpay Key
            "amount": amount, // Convert ₹ to paise
            "currency": "INR",
            "name": "Conference Registration",
            "description": "TechInnovate 2025 Registration",
            "prefill": {
                "name": name,
                "email": email,
